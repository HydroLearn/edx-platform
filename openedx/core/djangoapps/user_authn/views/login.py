...
def _do_third_party_auth(request):
    ...
    try:
        ...
        message = Text(_(
            ...
            u"but this account isn't linked with an {platform_name} account yet. {br_tags}"
            u"Use your {platform_name} username and password to log into {platform_name} below, "
            u"and then link your {platform_name} account with {provider_name} from your dashboard.{br_tags}"
...
def _generate_not_activated_message(user):
    ...
    not_activated_message = Text(_(
        u'In order to sign in, you need to activate your account.{br_tags}'
